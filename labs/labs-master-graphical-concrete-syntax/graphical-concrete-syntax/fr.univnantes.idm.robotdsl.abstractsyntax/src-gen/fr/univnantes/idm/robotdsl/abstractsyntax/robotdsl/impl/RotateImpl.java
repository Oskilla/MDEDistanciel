 ...
 * </p>
 * <ul>
 *   <li>{@link fr.univnantes.idm.robotdsl.abstractsyntax.robotdsl.impl.RotateImpl#getAngle <em>Angle</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RotateImpl extends CommandImpl implements Rotate {
	...
	protected EClass eStaticClass() {
		return RobotdslPackage.Literals.ROTATE;
	}
	...
	public void setAngle(int newAngle) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RobotdslPackage.ROTATE__ANGLE, oldAngle, angle));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case RobotdslPackage.ROTATE__ANGLE:
			return getAngle();
		}
